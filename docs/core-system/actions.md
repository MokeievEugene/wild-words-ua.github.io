...
### Завдання
Іноді важлива часова шкала. Завдання — це більш тривалі дії, що охоплюють більші проміжки часу, ніж звичайна дія і дозволяють персонажам виконати складніші, багатоетапні процедури (ймовірно, все ще з одним кидком, якщо він взагалі потрібен). 

Завдання, як правило, найкраще використовувати в межах свого типу сцени, яка дозволяє виконувати лише завдання (наприклад, монтаж), але технічно це не обов'язково має бути так.

_У **Дрейфі** персонажі, які хочуть дослідити станцію між подорожами, зазвичай роблять це за допомогою завдання. Один персонаж може побродити навколо, знайти крамницю та придбати щось — все за один кидок._

Іноді досягнення, наприклад, будівництво будинку, може вимагати виконання кількох окремих завдань. Це зазвичай називається **проєктом**, і, ймовірно, має власний трек, який потрібно заповнити перед завершенням.
