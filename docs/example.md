...
## Сцени
Поділяються на три окремі типи: Сцени, Монтажі та Мандрівки. Сцени охоплюють звичайні дії та дослідження.  Монтажі дозволяють персонажам виконати одне конкретне завдання. Подорожі дозволяють екіпажу взаємодіяти з їхнім спільним активом (кораблем) щоб переміщатися листяним морем з використанням чітких, ритуалізованих правил.
...
Завдання — це довші дії, які використовуються у сценах Монтажу.
...
### Проєкти
Виходять за часові рамки дій або завдань і потребують декількох дій чи завдань. Як їх позначати:
